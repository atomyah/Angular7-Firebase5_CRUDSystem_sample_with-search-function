...
export class EditStudentComponent implements OnInit {
  ...
  editForm: FormGroup; // フォームグループ。Define FormGroup to student's edit form

  // this.editForm = this.fb.group({処理})みたいのはupdateStudentData()関数で設定してる。
  // 普通はconstractor()の処理の所でやる
  ...
  // Contains Reactive Form logic
    ...
    updateForm() {
      ...
      this.toastr.success(this.editForm.controls['firstName'].value + ' は更新されました'); // Show succes message when data is successfully submited
